...
class Header extends Component{
    ...
    constructor(a){
     ...
     UsuarioHandle(data){
        if(data.props.currentUser.logged){
            ...
            return (<div className="navitem dropdown float-right col-sm-5 col-md-1">
            ...
            return <Link className="nav-link float-right" to="/login">Iniciar sesión</Link>;
        }
    ...
    render(){
        ...
        return(
            <nav className="navbar navbar-expand-lg navbar-light bg-light" style={{borderBottom:'1px solid #b1b1b1',zIndex:-1,position:"static"}}>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div className=" col-sm-12 col-md-3">
                    ...
                    <input className="form-control col-sm-8 col-md-8" type="search" placeholder={Lang.SEARCH[this.props.currentUser.lang]} aria-label="Buscar"/>
                    <button className="btn btn-outline-success  col-sm-4 col-md-4 my-2 my-sm-0" type="submit">{Lang.SEARCH[this.props.currentUser.lang]}</button>
                    </form>
                </div>
